const DEFAULT_SONGS = [
	{
		...
		artist: "RPT MCK",
		album: "HVL",
		src: "Media/Sound/Elegie.mp3",
		cover: "Media/Img/Elegie.jpg",
	},
	{
		title: "IDK",
		artist: "RPT MCK",
		album: "HVL",
		src: "Media/Sound/IDK.mp3",
		cover: "Media/Img/IDK.jpg",
	},
	{
		title: "Wtf Bby Im Lit",
		artist: "RPT MCK",
		album: "HVL",
		src: "Media/Sound/Wtf Bby Im Lit.mp3",
		cover: "Media/Img/Wtf Bby I_m Lit.jpg",
	},
	{
		title: "Anh Không Muốn Nó Dễ Dàng",
		artist: "RPT MCK",
		album: "HVL",
		src: "Media/Sound/Anh Không Muốn Nó Dễ Dàng.mp3",
		cover: "Media/Img/Anh Không Muốn Nó Dễ Dàng.jpg",
	},
	{
		title: "Baby",
		artist: "RPT MCK, marzuz",
		album: "HVL",
		src: "Media/Sound/Baby (feat. marzuz).mp3",
		cover: "Media/Img/Baby (feat. marzuz).jpg",
	},
	{
		title: "Yêu Anh Giết Anh",
		artist: "RPT MCK",
		album: "HVL",
		src: "Media/Sound/Yêu Anh Giết Anh.mp3",
		cover: "Media/Img/Yêu Anh Giết Anh.jpg",
	},
	{
		title: "Mắt Môi Tay Chân",
		artist: "RPT MCK, Tage",
		album: "HVL",
		src: "Media/Sound/Mắt Môi Tay Chân (feat. Tage).mp3",
		cover: "Media/Img/Mắt Môi Tay Chân (feat. Tage).jpg",
	},
	{
		title: "Đao Của Anh Vừa",
		artist: "RPT MCK",
		album: "HVL",
		src: "Media/Sound/Đao Của Anh Vừa.mp3",
		cover: "Media/Img/Đao Của Anh Vừa.jpg",
	},
	{
		title: "Là Gì Của Nhau",
		artist: "RPT MCK",
		album: "HVL",
		src: "Media/Sound/Là Gì Của Nhau.mp3",
		cover: "Media/Img/Là Gì Của Nhau.jpg",
	},
	{
		title: "Night In Prague",
		artist: "RPT MCK, Tùng Dương",
		album: "HVL",
		src: "Media/Sound/Night In Prague.mp3",
		cover: "Media/Img/Night In Prague.jpg",
	},
	{
		title: "Một Cái Ôm",
		artist: "RPT MCK",
		album: "HVL",
		src: "Media/Sound/Một Cái Ôm.mp3",
		cover: "Media/Img/Một Cái Ôm.jpg",
	},
	{
		title: "Liệm",
		artist: "RPT MCK",
		album: "HVL",
		src: "Media/Sound/Liệm.mp3",
		cover: "Media/Img/Liệm.jpg",
	},
	{
		title: "Nếu Như Ta Chẳng Còn",
		artist: "RPT MCK, AAP Ướt Mi",
		album: "HVL",
		src: "Media/Sound/Nếu Như Ta Chẳng Còn (feat. AAP Ướt Mi).mp3",
		cover: "Media/Img/Nếu Như Ta Chẳng Còn (feat. AAP Ướt Mi).jpg",
	},
	{
		title: "Ai Mới Là Kẻ Xấu Xa",
		artist: "RPT MCK",
		album: "HVL",
		src: "Media/Sound/Ai Mới Là Kẻ Xấu Xa.mp3",
		cover: "Media/Img/Ai Mới Là Kẻ Xấu Xa.jpg",
	},
	{
		title: "Slippery",
		artist: "RPT MCK, Tùng Dương",
		album: "HVL",
		src: "Media/Sound/Slippery (feat. Tùng Dương).mp3",
		cover: "Media/Img/Slippery (feat. Tùng Dương).jpg",
	},
	{
		title: "Intenpol",
		artist: "RPT MCK",
		album: "HVL",
		src: "Media/Sound/Intenpol.mp3",
		cover: "Media/Img/Intenpol.jpg",
	},
	{
		title: "Tây Thi",
		artist: "RPT MCK",
		album: "HVL",
		src: "Media/Sound/Tây Thi.mp3",
		cover: "Media/Img/Tây Thi.jpg",
	},
	{
		title: "Hút và Hút",
		artist: "RPT MCK",
		album: "HVL",
		src: "Media/Sound/Hút và Hút.mp3",
		cover: "Media/Img/Hút và Hút.jpg",
	},
	{
		title: "Dưa Chua",
		artist: "RPT MCK",
		album: "HVL",
		src: "Media/Sound/Dưa Chua.mp3",
		cover: "Media/Img/Dưa Chua.jpg",
	},
	{
		title: "Xa Xôi",
		artist: "RPT MCK, Obito",
		album: "HVL",
		src: "Media/Sound/Xa Xôi (feat. Obito).mp3",
		cover: "Media/Img/Xa Xôi (feat. Obito).jpg",
	},
	{
		title: "Che Phủ",
		artist: "RPT MCK",
		album: "HVL",
		src: "Media/Sound/Che Phủ.mp3",
		cover: "Media/Img/Che Phủ.jpg",
	},
	{
		title: "Oanh M = Thuoc",
		artist: "RPT MCK",
		album: "HVL",
		src: "Media/Sound/Oanh M Thuoc.mp3",
		cover: "Media/Img/Oanh M = Thuoc.jpg",
	},
	{
		title: "Ghet Xog Lai Thik",
		artist: "RPT MCK",
		album: "HVL",
		src: "Media/Sound/Ghet Xog Lai Thik.mp3",
		cover: "Media/Img/Ghet Xog Lai Thik.jpg",
	},
	{
		title: "Nhìn Kẻ Thù Của Tao",
		artist: "RPT MCK",
		album: "HVL",
		src: "Media/Sound/Nhìn Kẻ Thù Của Tao.mp3",
		cover: "Media/Img/Nhìn Kẻ Thù Của Tao.jpg",
	},
	{
		title: "Envy",
		artist: "RPT MCK, THANHDRAW",
		album: "HVL",
		src: "Media/Sound/Envy (feat. THANHDRAW).mp3",
		cover: "Media/Img/Envy (feat. THANHDRAW).jpg",
	},
	{
		title: "Cảm Ơn",
		artist: "RPT MCK",
		album: "HVL",
		src: "Media/Sound/Cảm Ơn.mp3",
		cover: "Media/Img/Cảm Ơn.jpg",
	},
	{
		title: "Không Cần Lo Cho Tao",
		artist: "RPT MCK",
		album: "HVL",
		src: "Media/Sound/Không Cần Lo Cho Tao.mp3",
		cover: "Media/Img/Không Cần Lo Cho Tao.jpg",
	},
	{
		title: "Huh",
		artist: "RPT MCK, RPT Orijinn, THANHDRAW",
		album: "HVL",
		src: "Media/Sound/Huh (feat. RPT Orijinn & THANHDRAW).mp3",
		cover: "Media/Img/Huh (feat. RPT Orijinn & THANHDRAW).jpg",
	},
	{
		title: "Nguyễn Văn Mười",
		artist: "RPT MCK",
		album: "HVL",
		src: "Media/Sound/Nguyễn Văn Mười.mp3",
		cover: "Media/Img/Nguyễn Văn Mười.jpg",
	},
	{
		title: "Thịt Lợn",
		artist: "RPT MCK",
		album: "HVL",
		src: "Media/Sound/Thịt Lợn.mp3",
		cover: "Media/Img/Thịt Lợn.jpg",
	},
];
...
class MusicPlayer {
	...
	setupEventListeners() {
		this.btnPlayMain.addEventListener("click", () => this.togglePlay());
